...
![huashan](./2019-05-06-jenkins-plugin-develop-within-two-days-part01/huashan.png)
...
![say hello world](./2019-05-06-jenkins-plugin-develop-within-two-days-part01/say-hello-world.png)
...
![maven-snapshot-check-plugin-usage](./2019-05-06-jenkins-plugin-develop-within-two-days-part01/maven-snapshot-check-plugin-usage.png)

如果检查到的话，则会将该次构建状态标记为失败。
![job-build-console-output](./2019-05-06-jenkins-plugin-develop-within-two-days-part01/job-build-console-output.png)
